...
export class Transfer extends Entity {
  ...
  get outOfAll(): BigDecimal {
    let value = this.get("outOfAll");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
  ...
  set outOfAll(value: BigDecimal) {
    this.set("outOfAll", Value.fromBigDecimal(value));
  }
  ...
  get isBeforePump(): boolean {
    let value = this.get("isBeforePump");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
  ...
  set isBeforePump(value: boolean) {
    this.set("isBeforePump", Value.fromBoolean(value));
  }
